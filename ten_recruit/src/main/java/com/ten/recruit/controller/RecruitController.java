package com.ten.recruit.controller;
import com.ten.recruit.pojo.Recruit;
import com.ten.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result recomment(){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.recomment());
	}
